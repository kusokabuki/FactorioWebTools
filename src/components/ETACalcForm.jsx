...
export default class ETACalcForm extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="etaForm">
                ...
                {eta !== null ? 
                    this.renderEtaInfo(train, eta) : <span>距離を入力してください</span>
                }
    ...
    renderEtaInfo(train, eta) {
        const fuel_rate = eta.fuel_consumed_joule / train.fuel.fuel_value;
        return (<dl>
            <dt>運行時間</dt>
            ...
            <dd>
                ...
                <span>{fuel_rate.toFixed(2)} 個分) </span><br />
                <span>{(0.5 / fuel_rate).toFixed(2)} 往復分</span>
            </dd>
        </dl>);
    }
}